...
public class CameraToMpegTest extends AndroidTestCase {
    ...
    /**
     * Tests encoding of AVC video from CameraAndroid input.  The output is saved as an MP4 file.
     */
    ...
    /**
     * Configures CameraAndroid for video capture.  Sets mCamera.
     * <p>
     * Opens a CameraAndroid and sets parameters.  Does not start preview.
     */
    private void prepareCamera(int encWidth, int encHeight) {
        ...
        Log.d(TAG, "CameraAndroid preview size is " + size.width + "x" + size.height);
    }
    ...
    private static void choosePreviewSize(Camera.Parameters parms, int width, int height) {
        ...
        if (VERBOSE && ppsfv != null) {
            Log.d(TAG, "CameraAndroid preferred preview size for video is " +
     ...
     * associated SurfaceTexture as the CameraAndroid's "preview texture".
     * <p>
     ...
     * <p>
     * The SurfaceTexture can be passed to CameraAndroid.setPreviewTexture() to receive camera output.
     */
                ...
                while (!mFrameAvailable) {
                    try {
                        ...
                        if (!mFrameAvailable) {
                            ...
                            throw new RuntimeException("CameraAndroid frame wait timed out");
                        }
